...
<body>
    ...
    <div class="header_section">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                <a class="logo" href={{ route('home') }}><img src="/assets/images/logo.png"></a>
    ...
    <div class="footer_section">
        <div class="container">
            <div class="footer_location_text">
                <ul>
                    <li><img src="/assets/images/map-icon.png"><span class="padding_left_10"><a href="#">Loram
                                Ipusm hosting web</a></span></li>
                    <li><img src="/assets/images/call-icon.png"><span class="padding_left_10"><a href="#">Call :
                                +7586656566</a></span></li>
                    <li><img src="/assets/images/mail-icon.png"><span class="padding_left_10"><a
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="footer_menu">
                        <ul>
                            ...
                            <li><a href={{ route('design') }}>Our Design</a></li>
    ...
    <script src="/assets/images/popper.min.js"></script>
    <script src="/assets/images/bootstrap.bundle.min.js"></script>
    <script src="/assets/images/jquery-3.0.0.min.js"></script>
    <script src="/assets/images/plugin.js"></script>
    <!-- sidebar -->
    <script src="/assets/images/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="/assets/images/custom.js"></script>
    <!-- javascript -->
    <script src="/assets/images/owl.carousel.js"></script>
