...
<head>
    <meta charset="utf-8">
    <title>{{$title ?? 'Jajji Profesor'}}</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Free HTML Templates" name="keywords">
    <meta content="Free HTML Templates" name="description">

    <!-- Favicon -->
    <link href="/assetsJ/img/favicon.ico" rel="icon">
    ...
    <!-- Flaticon Font -->
    <link href="/assetsJ/lib/flaticon/font/flaticon.css" rel="stylesheet">

    <!-- Libraries Stylesheet -->
    <link href="/assetsJ/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="/assetsJ/lib/lightbox/css/lightbox.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="/assetsJ/css/style.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            <img src="/assetsJ/img/logo jp.png" width="90" height="90" alt="lorem">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav font-weight-bold mx-auto py-0">
                    ...
                    <a href={{route('class')}} class="nav-item nav-link">Sinflar</a>
                    <a href={{route('teacher')}} class="nav-item nav-link">O'qituvchilar</a>
                    <a href={{route('wins')}} class="nav-item nav-link ">Yutuqlar</a>
                    <a href={{route('gallery')}} class="nav-item nav-link">Galereya</a>
                    <a href={{route('article')}} class="nav-item nav-link">Maqolalar</a>
                </div>
            </div>
            <a class="btn btn-primaryy px-4" href="Uzb"><img style="padding: 3px;"
                    src="/assetsJ/img/Uzbekistan-Flag-icon.png" width="35" height="35" alt="lorem"></a>
            <a class="btn btn-primaryy px-4" href="Uzb"><img style="padding: 3px;"
                    src="/assetsJ/img/united-states-of-america-flag-png-xl.png" width="35" height="35"
                    alt="lorem"></a>
            <a class="btn btn-primaryy px-4" href="Uzb"><img style="padding: 3px;"
                    src="/assetsJ/img/Russia-flag.png" width="35" height="35" alt="lorem"></a>
            <!-- <a  href="tel:+998996111300" class="btn btn-primary px-4"><img src="/assetsJ/img/missed-call.png" width="35" height="35" alt="lorem">  Qong'iroq qiling</a> -->
    </div>
    </nav>
    </div>
    <!-- Navbar End -->
    ...
    <script src="/assetsJ/lib/easing/easing.min.js"></script>
    <script src="/assetsJ/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="/assetsJ/lib/isotope/isotope.pkgd.min.js"></script>
    <script src="/assetsJ/lib/lightbox/js/lightbox.min.js"></script>

    <!-- Contact Javascript File -->
    <script src="/assetsJ/mail/jqBootstrapValidation.min.js"></script>
    <script src="/assetsJ/mail/contact.js"></script>

    <!-- Template Javascript -->
    <script src="/assetsJ/js/main.js"></script>
</body>
