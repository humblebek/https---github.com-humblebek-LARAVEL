        ...
        <div class="owl-carousel testimonial-carousel">
            <div class="testimonial-item px-3">
                ...
                <div class="d-flex align-items-center">
                    <img class="rounded-circle" src="/assetsJ/img/testimonial-1.jpg"
            ...
            <div class="testimonial-item px-3">
                ...
                <div class="d-flex align-items-center">
                    <img class="rounded-circle" src="/assetsJ/img/testimonial-2.jpg"
                        style="width: 70px; height: 70px;" alt="Image">
                    <div class="pl-3">
            ...
            <div class="testimonial-item px-3">
                ...
                <div class="d-flex align-items-center">
                    <img class="rounded-circle" src="/assetsJ/img/testimonial-3.jpg"
                        style="width: 70px; height: 70px;" alt="Image">
                    <div class="pl-3">
            ...
            <div class="testimonial-item px-3">
                ...
                <div class="d-flex align-items-center">
                    <img class="rounded-circle" src="/assetsJ/img/testimonial-4.jpg"
                        style="width: 70px; height: 70px;" alt="Image">
                    <div class="pl-3">
