<div class="row">
    <div class="col-lg-4 mb-5">
        <div class="card border-0 bg-light shadow-sm pb-2">
            <img class="card-img-top mb-2" src="/assetsJ/img/class-1.jpg" alt="">
    ...
    <div class="col-lg-4 mb-5">
        <div class="card border-0 bg-light shadow-sm pb-2">
            <img class="card-img-top mb-2" src="/assetsJ/img/class-2.jpg" alt="">
            <div class="card-body text-center">
    ...
    <div class="col-lg-4 mb-5">
        <div class="card border-0 bg-light shadow-sm pb-2">
            <img class="card-img-top mb-2" src="/assetsJ/img/class-3.jpg" alt="">
            <div class="card-body text-center">
